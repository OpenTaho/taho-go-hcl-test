...
#
# The content of the "101-in.tfvars" file is such that after processing the file
# the parser should be able to output a file that matches the content of the
# "101-out.tfvars" file.
