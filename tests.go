...
func testNewDir(t *testing.T, parser hcl.HclParser) {
	...
	expect(t, strconv.Itoa(len(files)), "10")
	...
	expect(t, files[5].Name(), wd+"/tests/01/101-out.tfvars")
	expect(t, files[6].Name(), wd+"/tests/01/101.tfvars")
	expect(t, files[7].Name(), wd+"/tests/01/102.tf")
	expect(t, files[8].Name(), wd+"/tests/01/103.hcl")
	expect(t, files[9].Name(), wd+"/tests/01/104.tf")
}
